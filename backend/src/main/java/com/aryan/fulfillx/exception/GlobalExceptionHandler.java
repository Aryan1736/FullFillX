...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<com.aryan.fulfillx.dto.response.ErrorResponse> handleNoResourceFound(
            NoResourceFoundException ex, HttpServletRequest request) {
        logException(ex, request, HttpStatus.NOT_FOUND);
        return buildErrorResponse(HttpStatus.NOT_FOUND, "Resource not found", request, List.of());
    }

    @ExceptionHandler(HttpRequestMethodNotSupportedException.class)
    public ResponseEntity<com.aryan.fulfillx.dto.response.ErrorResponse> handleMethodNotSupported(
            HttpRequestMethodNotSupportedException ex, HttpServletRequest request) {
        logException(ex, request, HttpStatus.METHOD_NOT_ALLOWED);
        return buildErrorResponse(HttpStatus.METHOD_NOT_ALLOWED, ex.getMessage(), request, List.of());
    }
    ...
    public ResponseEntity<ErrorResponse> handleDataIntegrityViolation(
        ...
        String message = "Resource conflict or constraint violation";
