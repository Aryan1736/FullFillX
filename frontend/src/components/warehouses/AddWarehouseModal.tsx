...
export function AddWarehouseModal({ isOpen, onClose }: AddWarehouseModalProps) {
  ...
  const handleSubmit = (event: FormEvent) => {
    ...
    createMutation.mutate(
      ...
      {
        onSuccess: (warehouse) => {
          showToast(`Warehouse "${warehouse.name}" registered successfully.`, { variant: 'success' })
          onClose()
        },
        onError: (error) => {
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-[#202027] bg-[#141417] px-6 py-4">
          <div>
            ...
            <h2 id="add-warehouse-title" className="mt-0.5 font-display text-base font-bold text-[#F4F4F5]">
              Add Fulfillment Hub
            </h2>
            <p className="mt-0.5 text-xs text-[#A1A1AA]">
              Register a new physical facility into the fulfillment network.
            </p>
          </div>
          <button
            type="button"
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          {/* Name & City */}
          <div>
            <label htmlFor="warehouse-name" className="block font-mono text-xs font-medium text-[#A1A1AA]">
            ...
            <input
              ...
              placeholder="e.g., Bengaluru South Distribution Center"
          ...
          <div>
            <label htmlFor="warehouse-city" className="block font-mono text-xs font-medium text-[#A1A1AA]">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="warehouse-latitude" className="block font-mono text-xs font-medium text-[#A1A1AA]">
            ...
            <div>
              <label htmlFor="warehouse-longitude" className="block font-mono text-xs font-medium text-[#A1A1AA]">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              <label htmlFor="warehouse-capacity" className="block font-mono text-xs font-medium text-[#A1A1AA]">
                Capacity (units) <span className="text-[#C4622D]">*</span>
              </label>
              <input
            ...
            <div>
              <label htmlFor="warehouse-load" className="block font-mono text-xs font-medium text-[#A1A1AA]">
                Initial Load (units) <span className="text-[#C4622D]">*</span>
              </label>
              <input
                id="warehouse-load"
                type="number"
